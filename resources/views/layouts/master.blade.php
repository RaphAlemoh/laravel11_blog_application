...
<head>
    ...
    <title>{{ config('app.name', 'Laravel 11 blog using bootstrap 5') }}</title>
...
<body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-light" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="{{ url('/') }}">Laravel 11 Blog with BT5</a>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; <a href="https://alemsbaja.hashnode.dev">AlemsBaja Blog</a> 2024</div>
                    </div>
                </div>
            </div>
        </footer>
