    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div class="my-5">
                    <form action="{{ route('posts.update', $post->ulid) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-floating">
                            <textarea class="form-control @error('content') is-invalid @enderror" name="content" placeholder="Enter your post here..." style="height: 12rem" required>
                            {{ $post->content }}
                        </textarea>
